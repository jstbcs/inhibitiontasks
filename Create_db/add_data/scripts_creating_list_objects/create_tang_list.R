# CREATE NESTED LIST OBJECT TO READ IN TANG ET AL DATA INTO DB ############################
...
# NOTE: read in dataset41 from "reformat_datasets.R"
...
# manually add additional rows to within_table
for(within in 2:14){
