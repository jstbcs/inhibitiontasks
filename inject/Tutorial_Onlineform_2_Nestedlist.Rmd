...
- If several tasks have been submitted for the same study, name the data file `processed_data_study[STUDYNUMBER]_task[TASKNUMBER]`
...
You can find out the numer of studies by running: 
```{r}
